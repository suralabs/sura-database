...
class Connection
{
	...
	public function connect(): void
    {
		...
		$class = empty($this->options['driverClass'])
			? 'Sura\Database\Drivers\\' . ucfirst(str_replace('sql', 'Sql', $this->pdo->getAttribute(PDO::ATTR_DRIVER_NAME))) . 'Driver'
	...
	{
		return (array)$this->query($sql, ...$params)->fetch();
	}
